...
public class Main implements Runnable{
	...
	public static void help(int descriptionAtLocation,int currentInventory) {
		...
		if(help.equalsIgnoreCase("help")) {
			...
			new HelpClass();
				...
				descV=true;
				enableNames=true;
			    String description = new HelpClass().description(descriptionAtLocation);
			    System.out.println(description);
			    System.out.println("\nEnter [ANY BUTTON] to go back to main console. ");
			    scanner.nextLine();

		}
		else if(help.equalsIgnoreCase("inventory")) {
			new HelpClass().inventory(currentInventory);
			System.out.println("\nEnter [ANY BUTTON] to go back to main console. ");
			scanner.nextLine();
		}
